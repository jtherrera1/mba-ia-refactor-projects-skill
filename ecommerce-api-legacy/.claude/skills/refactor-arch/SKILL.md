...
* Save the audit report to the project root at `reports/audit-project-2.md`.
...
*  During the refactoring, consider the issues identified in `reports/audit-project-2.md`.
